...
MOTHERDUCK_HOST_KEY = "motherduck_host"
MOTHERDUCK_REGION_HOST_KEY = "motherduck_region_host"
MOTHERDUCK_PORT_KEY = "motherduck_port"
MOTHERDUCK_USE_TLS_KEY = "motherduck_use_tls"
MOTHERDUCK_GRPC_LOCAL_SUBCHANNEL_POOL_KEY = "motherduck_grpc_local_subchannel_pool"
HOST_KEY = "host"
...
MOTHERDUCK_PATH_QUERY_KEYS = {
    ...
    MOTHERDUCK_HOST_KEY,
    HOST_KEY,
    MOTHERDUCK_REGION_HOST_KEY,
    REGION_HOST_KEY,
    MOTHERDUCK_PORT_KEY,
    PORT_KEY,
    MOTHERDUCK_USE_TLS_KEY,
    TLS_KEY,
    MOTHERDUCK_GRPC_LOCAL_SUBCHANNEL_POOL_KEY,
...
PATH_QUERY_ALIASES = (
    (MOTHERDUCK_HOST_KEY, HOST_KEY),
    (MOTHERDUCK_REGION_HOST_KEY, REGION_HOST_KEY),
    (MOTHERDUCK_PORT_KEY, PORT_KEY),
    (MOTHERDUCK_USE_TLS_KEY, TLS_KEY),
    (MOTHERDUCK_GRPC_LOCAL_SUBCHANNEL_POOL_KEY, GRPC_LOCAL_SUBCHANNEL_POOL_KEY),
