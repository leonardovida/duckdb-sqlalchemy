...
- preserve schema translation during register-backed bulk inserts, retaining the optimized path for mapped schemas ([#172](https://github.com/leonardovida/duckdb-sqlalchemy/pull/172))
